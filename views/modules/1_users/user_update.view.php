            ...
            <div class="col p-0">
                <div aria-label="breadcrumb">
                    <ol class="breadcrumb rounded-0 m-0 p-2 bg-white">
                        ...
                        <li class="breadcrumb-item active" aria-current="page">Acutalizar Usuario</li>
                    </ol>
                </div>
            </div>
        </div>
        ...
        <div class="contenido row bg-light p-2">
            <div class="col p-0 bg-light">
                <form id="formUserCreate" name="formUserUpdate"
                    class="card p-3 bg-dark text-white d-lg-flex justify-content-center w-100 border rounded p-2"
                    ...
                    <div class="form-row">
                        ...
                        <div id="foto_group" class="form-group col-md-6 ocultar-control">
                            ...
                            <input type="file" class="form-control p-1" id="foto" placeholder="Apellidos">
                        </div>
                        <div class="form-group col-md-6">
                        ...
                        <div id="fechaNac_group" class="form-group col-md-6 ocultar-control">
                            ...
                            <input type="date" class="form-control" id="fechaNac" placeholder="Nombres">
                        </div>
                        ...
                        <div id="salario_group" class="form-group col-md-6 ocultar-control">
                            ...
                            <input type="number" class="form-control text-right" id="salario" placeholder="salario"
                                value="1300000">
                        </div>
                    </div>
                    <input type="submit" id="submit-user-create" class="btn btn-info mb-2" value="Actualizar">
